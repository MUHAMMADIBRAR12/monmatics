<div class="navbar-right">
    ...
    <ul class="navbar-nav">
            ...
            <ul class="dropdown-menu slideUp2">
                ...
                <li class="body">
                    <ul class="menu app_sortcut list-unstyled">
                        <li>
                            <a href="<?php echo e(url('Crm/Contacts/List')); ?>">
                                <div class="icon-circle mb-2 bg-purple"><i class="zmdi zmdi-account-calendar"></i></div>
                                <p class="mb-0">Contacts</p>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('Crm/Notes/List')); ?>">
                                <div class="icon-circle mb-2 bg-green"><i class="zmdi zmdi-hc-fw"></i></div>
                                <p class="mb-0">Notes</p>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('Crm/TasksList')); ?>">
                                <div class="icon-circle mb-2 bg-amber"><i class="zmdi zmdi-hc-fw"></i></div>
        ...
        <li><a href="<?php echo e(url('Crm/Calender/View')); ?>" class="app_calendar" title="Calendar"><i class="zmdi zmdi-calendar"></i></a></li>
        ...
        <li><a href="<?php echo e(route('authentication.login')); ?>" class="mega-menu" title="Sign Out"><i class="zmdi zmdi-power"></i></a></li>
    </ul>
</div>
<?php /**PATH C:\xampp\htdocs\app\resources\views/layout/navbarright.blade.php ENDPATH**/ ?>