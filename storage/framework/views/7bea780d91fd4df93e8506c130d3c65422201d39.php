<?php $__env->startSection('title', 'Form Options List'); ?>
...
<div class="row clearfix">
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
              <button class="btn btn-primary" style="align:right" onclick="window.location.href = '<?php echo e(url('Admin/FormOptions/Create')); ?>';" >Add New Options</button>
            </div>
            <div class="body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover" id="form_options">
                        ...
                        <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                            <tr>
                                <td class="action">
                                    <a class="btn btn-primary btn-sm p-0 m-0"  href="<?php echo e(url('Admin/FormOptions/Create/'.$option->id)); ?>">
                                ...
                                <td class="column_size"><?php echo e($option->type); ?></td>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/system/form_options_list.blade.php ENDPATH**/ ?>