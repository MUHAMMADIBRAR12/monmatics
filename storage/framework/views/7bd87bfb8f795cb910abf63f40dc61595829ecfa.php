...
<head>
    ...
    *{}
     ...
     .navvv {
         background-image:url('<?php echo e(asset('public/assets/images/Untitled.png')); ?>');
...
<header>
  ...
  <ul class="dropdown-menu   drop  dropdown-menu-end">
    ...
    <div class="container-fluid  ">
        ...
        <div class="">
            <a class="navbar-brand" href="">
                <img class="" src="<?php echo e(asset('public/assets/images/Back Arrow.png')); ?>" alt="" style="height: 40px; margin-left: 30px;
                    ">
            </a>
        </div>
    </nav> -->
            ...
            <div class="col-md-5  d-none d-md-block offset-1 position-relative top-1 navvv">
    ...
    <footer class="container">
          ...
          <div class="row mt-5">
            <div class="col-md-12 mb-md-0 mb-4 mt-5">
              ...
              <div class=" col-md-12">
                ...
                <div class="ft4  mt-3" style="  border-bottom-style: solid;border-bottom-color: white;"></div>
                <div class="mt-3"> 
      ...
      <div class="row pb-2">
        <div class="col-md-8  mb-3  te">
          <a href="">
            <p class="text-white" style="margin-right: 20px;border-bottom: 1.5px solid  white;width:auto">Privacy</p></a>
          <a href="">
            <p class="text-white">Terms and conditions</p></a>
        </div>
        <div class="col-md-4 text-white" style="font-size: 15px;">
        <p>© 2024 monmatics Inc. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  </section>
...
</html><?php /**PATH C:\xampp\htdocs\app\resources\views/web/bookkeeperLogin.blade.php ENDPATH**/ ?>