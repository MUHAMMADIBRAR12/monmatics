            ...
            <div class="slim_scroll">
                <div class="card">
                    ...
                    <div class="light_dark">
                        <form action="<?php echo e(route('set-theme')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="user_id" value="<?php echo e(auth()->id()); ?>">
                            <div class="radio">
                                <input type="radio" name="theme" id="lighttheme" value="light" <?php echo e(session('theme', 'light' )==='light' ? 'checked' : ''); ?>>
                                <label for="lighttheme">Light Mode</label>
                            </div>
                            <div class="radio mb-0">
                                <input type="radio" name="theme" id="darktheme" value="dark" <?php echo e(session('theme')==='dark' ? 'checked' : ''); ?>>
...
</aside><?php /**PATH C:\xampp\htdocs\app\resources\views/layout/rightsidebar.blade.php ENDPATH**/ ?>