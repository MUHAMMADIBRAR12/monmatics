    ...
    <div class="container  ">
      <div class="  row  custom-maxWidthim    ">
        ...
        <div class=" col-md-5  d-md-block  d-none  mt-5  " >
            <img class="" src="<?php echo e(asset('public/assets/images/Main screen video 1.svg')); ?>" alt="" style="width:98%">
        </div>
        ...
        <div class="col-12  mb-5">
          <div class="image-container d-flex">
            ...
            <div class="image-item">
              <img src="<?php echo e(asset('public/assets/images/Accept Payment.svg')); ?>" alt="">
              <h5 class="blue mt-3">Accept Payment</h5>
            </div>

            <div class="image-item">
              <img src="<?php echo e(asset('public/assets/images/Claim expenses.svg')); ?>" alt="">
              <h5 class="blue mt-3">Claim expenses</h5>
            </div>

            <div class="image-item">
              <img src="<?php echo e(asset('public/assets/images/Bank connections.svg')); ?>" alt="">
              <h5 class="blue mt-3">Bank connections</h5>
            </div>

            <div class="image-item">
              <img src="<?php echo e(asset('public/assets/images/Pay bills.svg')); ?>" alt="">
              <h5 class="blue mt-3 ml-4">Pay bills</h5>
            </div>

            <div class="image-item">
              <img src="<?php echo e(asset('public/assets/images/Ellipse 7.svg')); ?>" alt="">
      ...
      <section >
        ...
        <div class="row  custom-maxWidth">
          <div class="col-md-4 ">
            ...
            <div class="  Apps-image-container  d-flex  justify-content-evenly  ">
              ...
              <div class="Apps-image-item  scl">
                <img   src="<?php echo e(asset('public/assets/images/CRM.svg')); ?>" alt="">
                <div class="ml-3 mt-1">CRM</div>
              </div>
           
                <div class="scl">
                <img  src="<?php echo e(asset('public/assets/images/POS.svg')); ?>" alt="">
                <div class="ml-3 mt-1">POS</div>
                </div>
           
           
                <div class="scl">
                <img  src="<?php echo e(asset('public/assets/images/Sales.svg')); ?>" alt="">
          ...
          <div class="col-md-4  mb-5 ">
            ...
            <div class="d-flex  r3  mt-2">
              <div class="scl">
                <img src="<?php echo e(asset('public/assets/images/Project.svg')); ?>" >
                <div class="ml-1  mt-2">Project</div>
              </div>
              <div class="scl">
                <img src="<?php echo e(asset('public/assets/images/Timesheet.svg')); ?>"  alt="">
                <div class=" mt-2">Timesheet</div>
              </div>
              <div class="scl">
                <img class="" src="<?php echo e(asset('public/assets/images/HelpDesk.svg')); ?>"  alt="">
          ...
          <div class="col-md-4  mb-3  mt-5 ">
            ...
            <div class="d-flex  r3  mt-3">
              <div class="scl">
                <img src="<?php echo e(asset('public/assets/images/Inventory.svg')); ?>" alt="">
                <div class="ml-1  mt-2">Inventory</div>
              </div>

              <div class="scl">
                <img src="<?php echo e(asset('public/assets/images/MRP.svg')); ?>" alt="">
                <h6 class="ml-3 mt-2">MRP</h6>
              </div>
              <div class="scl">
                <img class="" src="<?php echo e(asset('public/assets/images/Purchase.svg')); ?>" alt="">
        ...
        <div class=" col-md-4 mb-3">
            ...
            <div class="d-flex    mt-3  justify-content-evenly">
              <div class="scl">
                <img src="<?php echo e(asset('public/assets/images/Invoicing.svg')); ?>">
                <div class="ml-1  mt-1">Inventory</div>
              </div>
              <div class="scl">
                <img src="<?php echo e(asset('public/assets/images/Accountingg.svg')); ?>" alt="">
          ...
          <div class=" col-md-4 mb-3">
            ...
            <div class="d-flex    mt-3  justify-content-evenly">
              <div class="scl">
                <img src="<?php echo e(asset('public/assets/images/Studio.svg')); ?>">
                <div class="ml-1  mt-1">Studio</div>
              </div>
              <div class="scl">
                <img src="<?php echo e(asset('public/assets/images/monmatics.sh.svg')); ?>" alt="">
  ...
  <section>
        <div class="container  ">
          <div class="row">
            ...
            <img src="<?php echo e(asset('public/assets/images/Frame 77.svg')); ?>"  class="mt-5" style="width:100%"  alt="">
            </div>
  ...
  <section>
    <div class="container ">
      <div class="row d-flex justify-content-evenly mt-5 mb-5 ">
        ...
        <img src="<?php echo e(asset('public/assets/images/WhatsApp Image 2023-07-06 at 10.41 1.svg')); ?>" alt="">
        </div>
      </div>
        ...
        <h3 class="text-white  text-center mt-5">For accountants and bookkeepers</h3>
                ...
                <div>
                  <div class="text-center">
                    ...
                    <img class="ml-4" src="<?php echo e(asset('public/assets/images/Rectangle 34.svg')); ?>" alt="" style="width: 80%">
                  </div>
      </div>
      </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('web.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/web/home.blade.php ENDPATH**/ ?>