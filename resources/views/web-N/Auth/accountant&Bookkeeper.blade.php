    ...
    <style>
        ...
        :root {
         ...
         @media (max-width: 767px) {
            ...
            .container-fluid{font-size: 11px;}
            .main .wrapper .form .input-field {
             font-family: inherit;
             font-size: 10px;
             font-weight: 400;
  ...
  <body>
        ...
        <div class="container-fluid loginBackground " >
           <div class="row">
                ...
                <main class="main">
                    <div class="container">
                        <section class="wrapper">
                            ...
                            <form name="signin" action="{{ route('create_Accountant') }}" method="post" class="form">
                                ...
                                <div class="input-control form-group">
                                 ...
                                 <div class="input-control form-group">
                                    ...
                                    <input type="phone" name="phone" id="phone"  class="input-field form-control" placeholder="Phone">
                                </div>
                                 <div class="input-control form-group">
            ...
            <div class="col-md-6 -mobile navvv" style=" border-top-left-radius: 70%;">
                {{-- <img class="" src="{{asset('public/assets/web_assets/images/Accountants Bookkeepers Sign Up Page (1).svg')}}"  alt="" style=""> --}}
            </div>
           </div>
            <div class="container">
                <div class="text-left">
