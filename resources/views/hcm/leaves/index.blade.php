        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                <div class="d-flex justify-content-end mb-3">
                    <a href="{{ route('leave.create') }}" class="btn btn-primary">New Leave</a>
                </div>
                <div class="body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover" id="leaves">
                            <thead>
                            <tr>
                                <th class="">Action</th>
                                <th>Leave Group</th>
    ...
    <script>
        ...
        document.querySelectorAll('.delete-form').forEach(form => {
            form.addEventListener('submit', function (event) {
                ...
                const confirmation = confirm('Are you sure you want to delete this leaves?'); // Display confirmation dialog
                if (confirmation) {
