...
<div class="row clearfix">
    <div class="col-lg-3 col-md-6 col-sm-12">
        <a href="{{ url('Purchase/PurchaseInvoice/List') }}">
            <div class="card widget_2 big_icon traffic">
                <div class="body">
                    <h6>Payable Invoices</h6>
                    <h2>{{ $total_invoice ?? '0' }} <small class="badge badge-success">Amount: {{ $totla_inv_amount ??
                            '0' }}</small>
                    </h2>
    ...
    <div class="col-lg-3 col-md-6 col-sm-12">
        <a href="{{ url('Sales/Invoice/List') }}">
            <div class="card widget_2 big_icon sales">
                <div class="body">
                    <h6>Receivable Invoices</h6>
                    <h2>{{ $total_sale_invoice ?? '0' }} <small class="badge badge-success">Amount:
                            {{ $totla_sale_inv_amount->balance ?? '0' }}</small></h2>
    ...
    <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="card widget_2 big_icon email">
            <div class="body">
                <h6>Banks</h6>
                <h2>{{ $bank ?? '0' }} <small class="badge badge-success">Amount: {{ $total_bank->total_bank ?? '0'
                        }}</small></h2>
    ...
    <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="card widget_2 big_icon domains">
            <div class="body">
                <h6>Cash</h6>
                <h2>{{ $cash ?? '0' }} <small class="badge badge-success">Amount: {{ $total_cash->total_cash ?? '0'
                        }}</small></h2>
            ...
            <div class="body">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <span> More than 30% percent of users come from direct links. Check details page for more
                            information.</span>
