...
<div class="row clearfix">
    <div class="card col-lg-12">
        <div class="header">
            <div class="row">
                <div class="col-md-9">
                    <h2><strong>Email</strong> Template Edit</h2>
                </div>
                <div class="col-md-3">
        ...
        @endif
        <div class="body">
        <form method="POST" action="{{ url('Crm/EmailTemplates/update/' . $templateList->id) }}">
         @csrf
         <input type="hidden" name="edit_email_template_id" value="{{ $templateList->id }}">

                <div class="row">
                    <div class="col-md-6">
                    <div class="form-group">
                        <label for="role">Template name</label>
                        <input type="text" name="temp_name" class="form-control" value="{{ $templateList->template_name }}" required>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="subject" class="form-control" value="{{$templateList->subject}}" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="form-group">
                    <label for="role">Subject</label>
                    <textarea name="bodytext">{{ $templateList->body_text }}</textarea>
                    </div>
