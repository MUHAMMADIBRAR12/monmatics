        ...
        <div class="card">
            <div class="body">
                <div class="table-responsive">
                    <button class="btn btn-primary" style="align:right" onclick="window.location.href = '{{ url('Crm/CutomerCategory/Create') }}';" >New Category</button>
                    @if (Session::has('msg'))
                    ...
                    @endif
                        ...
                        <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="action">
                                        <a class="btn btn-success btn-sm" href="{{url('Crm/CustomerCategory/Edit/'.$category->id)}}">
                                            <i class="zmdi zmdi-edit"></i>
                                        </a>
                                        <a class="btn btn-danger btn-sm del" data-toggle="modal" data-target="#modalCenter{{$category->id}}">
                                ...
                                <div class="modal fade" id="modalCenter{{$category->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a class="btn btn-primary model-delete" href="{{ url('Crm/CustomerCategory/Remove', ['id' => $category->id]) }}">Yes</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
