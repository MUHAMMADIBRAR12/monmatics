...
class VendorPaymentController extends Controller
{
    ...
    public function save(Request $request)
    {
        ...
        if ($request->type > -1) {
            ...
            //before updated fs_transdetail we call this function to delte transaction related to this trm id.
            accountsLib::delTransDetail($trmId);
            //save transdetails data    // Bank/Cash account
            $transDetails = array(
                "trm_id" => $trmId,
        ...
        //invoice payment function store update  data in fs_invoice_payment table
        $inpId = $this->invoicePayment($trmId, $request);
        //invoice payment detail function store data invoice_payment_detail table
    ...
    {
        //first delete record from fs_invoice_payment_details
