        ...
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="table-responsive">
                    <table id="transactionList" class="table table-bordered table-striped table-hover js-exportable dataTable" style="width:100%">
                        <thead>
                                <th>Sr</th>
                                <th>Edit</th>
                                <th>Print</th>
...
t = $('#transactionList').DataTable({
    ...
    columnDefs: [
        { className: "dt-center column_size", targets: [0, 1, 2, 3, 4] },
        { className: "dt-right column_size", targets: [6, 7] },
    ...
    buttons: [
        ...
        },
        {
            ...
            title: 'Products',
            exportOptions: {
            columns: [0,3,4,5,6,7] // Exclude the first column from CSV export
          },
        },
        {
            extend: 'pdf',
...
<script>
var token =  "{{ csrf_token()}}";
var url = "{{ url('getTransactionList') }}";
