          ...
          <div class="row ">
            <div class="col-md-12 ">
              ...
              <p class="p-4 text-center">Track your business on the move and have confidence in your figures no matter
                where
                you are</p>
              <h6 class="m11 text-center">Monmatics Accounting app</h6>
        ...
        <div class=" col-md-5   pr-3 c9 mt-1  offset-md-1">
          <div class="row ">
            <div class="col-md-12 ">
              ...
              <div class="text-center   ss2">
              <img src="{{ asset('public/assets/images/Rectangle 34.svg')}}" alt="" >
      ...
      <div class="container  ">
        <div class="row">
          ...
          <div class="col-md-5 p-5">
            <button class="buttonUnleash mt-5"> Try monmatics </button>
          </div>
        </div>
      </div>
    </div>
