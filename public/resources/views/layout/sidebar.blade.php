...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="navbar-brand">
        ...
        <a href="{{ route('dashboard.index') }}"><img src="{{ asset('public/assets/images/logo2.png') }}"
    ...
    <div class="menu">
        <ul class="list">
            <li>
                <summary>
                    <div class="user-info"
                        onclick="window.location.href = '{{ url('Admin/Users/Create/' . $user->id . '/p') }}';">
                        <div class="image"><a href="#"><img src="{{ url('display/' . $user->id) }}" alt="User"></a>
                        </div>
                        <div class="detail">
                            <h4>{{ $user->firstName }}&nbsp{{ $user->lastName }}</h4>
            ...
            <li class="{{ Request::segment(1) === 'app' ? 'active open' : null }}">
                <a href="{{ $module->route }}" class="menu-toggle"><i class="zmdi {{ $module->image }}"></i>
                    <span>{{ $module->module }}</span></a>
                    @if ($module->has_child != 0)
                    <ul class="ml-menu ">
                        @foreach ($module->has_child as $child)
                        <li class="{{ Request::is($child->route) ? 'active' : '' }}"><a href="{{ url($child->route) }}">{{ $child->module }}</a></li>
                        @endforeach
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        ...
                        <li class="{{ Request::segment(2) === 'new-post' ? 'active' : null }}"><a href="{{ route('blog.posts') }}">Blog Posts</a></li>
                        ...
                        <li class="{{ Request::segment(2) === 'detail' ? 'active' : null }}"><a href="{{ route('blog.category') }}">Category</a></li>
    
                    </ul>
                </li>
            <li style="height:70px" class="{{ Request::segment(1) === 'app' ? 'active open' : null }} ">
                &nbsp;&nbsp;
            </li>
            ...
            <li class="{{ Request::segment(1) === 'app' ? 'active open' : null }}">
                ...
                <ul class="ml-menu">
                    <li class="{{ Request::segment(2) === 'inbox' ? 'active' : null }}"><a href="{{ route('app.inbox') }}">Chart of Accounts</a></li>
                    <li class="{{ Request::segment(2) === 'chat' ? 'active' : null }}"><a href="{{ route('app.chat') }}">Chat</a></li>
                    <li class="{{ Request::segment(2) === 'calendar' ? 'active' : null }}"><a href="{{ route('Crm/Calendar') }}">Calendar</a></li>
                    <li class="{{ Request::segment(2) === 'contact-list' ? 'active' : null }}"><a href="{{ route('app.contact-list') }}">Contact list</a></li>
                    <li class="{{ Request::segment(2) === 'contact-list' ? 'active open' : null }}">
                        <a href="#App" class="menu-toggle"><i class="zmdi zmdi-apps"></i> <span>App2</span></a>
                        <ul class="ml-menu">
                            <li class="{{ Request::segment(2) === 'contact-list' ? 'active' : null }}"><a href="{{ route('app.contact-list') }}">Contact list3</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
