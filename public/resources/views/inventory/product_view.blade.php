    ...
    <div class="card col-lg-12">
            ...
            <div class="tab-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group "><p class="text-primary">{{ $product->brand ?? ''  }}</p></div>
                    </div>                          
                    <div class="col-md-3">
                ...
                <div class="row">
                    <div class="col-md-3">
                       ...
                       <div class="form-group"><p class="text-primary">{{$product->pri_unit}}</p></div>
                    </div>                        
                    <div class="col-md-3">
                        <label for="secondary_unit">Purchase Unit</label>
                       <div class="form-group"><p class="text-primary">{{$product->pur_unit}}</p></div>
                    </div>
                    <div class="col-md-3">
                        <label for="secondary_unit">Sale Unit</label>
                       <div class="form-group"><p class="text-primary">{{$product->sal_unit}}</p></div>
                    </div>                        
                    <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">                                                              
                                <a href="{{asset('assets/products/'.$attachment->file)}}" download >
                                    <img src="{{asset('public/assets/products/'.$attachment->file)}}"></img>
                                </a>                                    
                            </div>
                        </div> 
                    @endforeach
        ...
        <div class="row">
            <table class=" table-responsive align-center">
                <tr>
                    <td><button class="btn btn-primary" onclick="window.location.href = '{{ url('Inventory/Product/Create/'.$product->id) }}';"><i class="zmdi zmdi-edit"></i> | Edit</button></td>
