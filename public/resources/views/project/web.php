...
Route::get('login', function () { return redirect('authentication/login'); });
...
//Business
Route::get('/Business-Registration', function () { return view('web.Auth.business');});
Route::get('/Business-Registration-Detail', function () { return view('web.Auth.businessDetail');});
...
Route::get('/Accountant&Bookkeeper', function () { return view('web.Auth.accountant&Bookkeeper');});
