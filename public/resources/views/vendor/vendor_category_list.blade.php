        ...
        <div class="card">
            <div class="body">
                <div class="table-responsive">
                    <button class="btn btn-primary" style="align:right" onclick="window.location.href = '{{ url('Vendor/VendorCategory/Create') }}';" >New Vendor Category</button>
                    @if (Session::has('msg'))
	                  <div class="alert alert-danger">{{ Session::get('msg') }}</div>
                    @endif
                        
                        <table class="table table-bordered table-striped table-hover" id="vendor_categories">
                        <thead>
                            <tr>
                            ...
                            <tbody>
                             ...
                             <tr>
                                <td class="action">
                                    <a class="btn btn-success btn-sm p-0 m-0"  href="{{url('Vendor/VendorCategory/Create/'.$category->id)}}">
