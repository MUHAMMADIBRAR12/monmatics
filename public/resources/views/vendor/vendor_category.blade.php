...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="body">
                <form class="form-horizontal" action="{{url('Vendor/VendorCategory/Add')}}" method="post">
                   {{ csrf_field() }}
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-4 form-control-label">
                         ...
                         <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="form-group">
                                <input type="text" id="category" name="category" class="form-control" placeholder="Category Name --" value="{{ $category->category ?? ''}}" required>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="form-group">
