...
@section('content')
    <div class="row clearfix">
        <div class="col-lg-12">
            <div class="card">
                <div class="header">
                    <h2><strong>Trial</strong> Balance </h2>
                </div>
                <div class="body">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-3 col-sm-12">
                            <input type="checkbox" name="groupAccount" id="groupAccount">
                            <label for="groupAccount">Group Account</label>
                        </div>
...
@section('page-script')
    ...
    <script>
        function myDataTable() {
            fname = 'Trial Balance ' + $('#from_date').val() + '   ' + $('#date').val();
    ...
    <script>
        ...
        $('#generate').click(function() {
            ...
            var isChecked = $('#groupAccount').is(':checked');
            var groupAccount = isChecked ? $('#groupAccount').val() : '';
            var total_debit = 0;
            var total_credit = 0;
            var total_balance = 0;
            $.post(url, {
                ...
                data.map(function(val, i) {
                    t.row.add([
                        '<td>' + sr + '</td>',
                        '<td>' + val.account + '</td>',
                        '<td style="text-align:right !important;">' + val.debit +
                        '</td>',
                        '<td style="text-align:right !important;">' + val.credit +
                        '</td>',
                        '</tr>',
                    ]).draw(false);
                    sr++;
                    if (val.group_trans == '1') {
